                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" class="status-verif d-none"
                                            value="<?=esc($value->id_pdl)?>">
                                        <a href="<?=base_url('puskom/pdl/pddsk/detail/' . $value->id_pdl)?>"
                                        ...
                                        <a href="<?=base_url('puskom/pdl/pddsk/detail/' . $value->id_pdl)?>"
                                            class="btn btn-primary btn-sm">Lihat Berkas</a>
                                        <a href="<?=base_url('puskom/pdl/pddsk/acc/' . $value->id_pdl)?>"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?=site_url('puskom/pdl/pddsk/tolak/' . $value->id_pdl)?>"
                                                    method="post">
                                                    <div class="mb-3">
...
downloadButton.addEventListener('click', function() {
    ...
    if (selectedIds.length > 0) {
        ...
        form.method = 'POST';
        form.action = '<?=base_url('puskom/pdl/pddsk/download')?>';
