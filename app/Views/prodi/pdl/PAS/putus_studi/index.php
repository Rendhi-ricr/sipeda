...
<?= $this->section('title') ?>Perubahan Antar Status<?= $this->endSection() ?>
...
<div class="container-fluid p-0">
    ...
    <div class="mb-3">
        <div class="row">
            <div class="col-md-6">
                <h1 class="h3 d-inline align-middle">Perubahan Antar Status</h1>
            </div>
            <div class="col-md-6">
                <div class="text-end">
                    <a href="<?= site_url('/prodi/pdl/putus_studi/tambah') ?>" class="btn btn-primary"><i class="ti ti-plus ti-sm"></i> Tambah</a>
                </div>
            </div>
        </div>
    </div>
