...
namespace App\Controllers\Puskom\Pdl;
...
class Pddsk extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('puskom/pdl/pddsk/index', $data);
    }
    ...
    public function detail($id_pdl)
    {
        ...
        if ($pdl) {
            ...
            return view('puskom/pdl/pddsk/berkas', $data);
        } else {
            return redirect()->to('/puskom/pdl/pddsk')->with('error', 'Transaksi tidak ditemukan.');
        }
    }
    ...
    public function acc($id_pdl)
    {
        ...
        return redirect()->to('/puskom/pdl/pddsk');
    }
    ...
    public function download() {
        ...
        foreach ($pdl_ids as $id_pdl) {
            ...
            if ($data_pdl['status_pengajuan'] == 'Proses Pengajuan Dikti') {
                ...
                if (file_exists(WRITEPATH . 'uploads/pdl/pddsk/' . $files['file'])) {
                    // Download file
                    return $this->response->download(WRITEPATH . 'uploads/pdl/pddsk/' . $files['file'], null)->setFileName($files['file']);
                } else {
                    // Log error if file not found
                    log_message('error', 'File not found: ' . WRITEPATH . 'uploads/pdl/pddsk/' . $files['file']);
                }
