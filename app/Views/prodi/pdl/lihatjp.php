...
<div class="container-fluid p-0">
    <a href="<?= base_url('/prodi/pdl'); ?>" class="btn btn-secondary btn-sm my-4"><i class="bx bx-right-arrow-alt"></i> Kembali</a>

    <form id="editor-form" action="<?= site_url('prodi/pdl/jp/' . $id_pdl) ?>" method="post" enctype="multipart/form-data">
        <div class="row mb-3">
            <div class="col-md-12">
