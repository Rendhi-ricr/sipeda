...
<div class="container-fluid">
    ...
    <a href="<?= base_url('/prodi/pdm'); ?>" class="btn btn-secondary btn-sm my-4"><i class="bx bx-left-arrow-alt"></i> Kembali</a>
    <?php if ($pdm->status_pengajuan === 'Draft'): ?>
        <a href="<?= base_url('/prodi/pdm/edit/' . $pdm->id_pdm); ?>" class="btn btn-primary btn-sm my-4"><i class="bx bx-edit"></i> Edit</a>
    <?php endif; ?>
