...
<div class="container-fluid">
    ...
    <a href="<?= base_url('/prodi/pdl'); ?>" class="btn btn-secondary btn-sm my-4"><i class="bx bx-left-arrow-alt"></i> Kembali</a>
    <?php if ($pdl->status_pengajuan === 'Draft'): ?>
        <a href="<?= base_url('/prodi/pdl/edit/' . $pdl->id_pdl); ?>" class="btn btn-primary btn-sm my-4"><i class="bx bx-edit"></i> Edit</a>
    <?php endif; ?>
                ...
                <div class="row mb-3">
                    <?php foreach ($bpm as $r): ?>
                        <div class="col-md-6">
                            ...
                            <iframe src="<?= base_url('uploads/pdl/' . $r['file']); ?>" height="600px" width="100%" style="border: none;" title="Detail Berkas"></iframe>
                        </div>
