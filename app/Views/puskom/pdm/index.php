                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($pdm as $value): ?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" class="select-item" value="<?= esc($value->id_pdm); ?>">
                                        ...
                                        <td>
                                            <?php if ($value->status_pengajuan === 'Verifikasi Pimpinan'): ?>
                                                <input type="hidden" class="status-verif d-none"
                                                    value="<?= esc($value->id_pdm) ?>">
                                                <a href="<?= base_url('puskom/pdm/detail/' . $value->id_pdm) ?>"
                                            ...
                                            <?php elseif ($value->status_pengajuan === 'Verifikasi Berkas'): ?>
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    <a href="<?= base_url('puskom/pdm/detail/' . $value->id_pdm) ?>"
                                                        class="btn btn-primary btn-sm">Lihat Berkas</a>
                                                    <a href="<?= base_url('puskom/pdm/acc/' . $value->id_pdm) ?>"
                                                        class="btn btn-success btn-sm"
                                                        onclick="return confirm('Apakah anda yakin ingin menerima data ini?')">Acc</a>
                                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#modalTolak-<?= $value->id_pdm ?>">Tolak</button>
                                                </div>
                                            <?php endif; ?>
                                        </td>

                                    </tr>
                                    <div class="modal fade" id="modalTolak-<?= $value->id_pdm ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?= site_url('puskom/pdm/tolak/' . $value->id_pdm) ?>"
                                                        method="post">
                                                        <div class="mb-3">
...
<script>
    ...
    downloadButton.addEventListener('click', function() {
        ...
        if (selectedIds.length > 0) {
            ...
            form.method = 'POST';
            form.action = '<?= base_url('puskom/pdm/downloadMultiple') ?>';
