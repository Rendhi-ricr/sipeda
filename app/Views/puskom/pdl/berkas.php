...
<?= $this->section('title'); ?>Lihat Berkas PDL <?= $this->endSection() ?>
<?= $this->section('content') ?>

<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Lihat Berkas PDL</h1>
    </div>
    <a href="<?= base_url('/puskom/pdl'); ?>" class="btn btn-secondary btn-sm my-4"><i class="bx bx-left-arrow-alt"></i> Kembali</a>
